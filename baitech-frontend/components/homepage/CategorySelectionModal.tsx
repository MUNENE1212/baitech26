...
export function CategorySelectionModal() {
  ...
  return (
    <section className="relative min-h-[70vh] flex items-center bg-gradient-to-br from-zinc-50 via-white to-amber-50 py-12">
                                ...
                                >
                                  ...
                                  {service.pricing && (
                                    <div className="text-xs text-amber-600">
                                      From Ksh {typeof service.pricing === 'number' ? service.pricing.toLocaleString() : service.pricing}
                                    </div>
                                  )}
                                </div>
                              ))}
