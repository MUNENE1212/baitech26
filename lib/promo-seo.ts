...
export const PROMO_STRUCTURED_DATA = {
  blackFriday: {
    ...
    name: 'Black Friday Sale 2025-2026 - Baitech Kenya',
...
export const PROMO_META_TAGS = {
  blackFriday: {
    title: 'Black Friday 2025-2026 Kenya - Up to 70% OFF Electronics | Free Gifts | Baitech',
    ...
    openGraph: {
      title: 'Black Friday 2025-2026 - Up to 70% OFF + Free Gifts | Baitech Kenya',
      ...
      images: [
        {
          url: 'https://baitech.co.ke/black-friday-2025.jpg',
          width: 1200,
          height: 630,
          alt: 'Black Friday 2025-2026 Sale - Baitech Kenya',
        },
      ],
      type: 'website',
    },
  ...
  giftcember: {
    title: 'GIFTCEMBER 2025-2026 - Free Gifts with Every Purchase | Baitech Kenya',
    ...
    openGraph: {
      ...
      images: [
        {
          url: 'https://baitech.co.ke/giftcember-2025.jpg',
          width: 1200,
          height: 630,
          alt: 'GIFTCEMBER 2025-2026 - Free Gifts Campaign - Baitech Kenya',
        },
      ],
      type: 'website',
    },
